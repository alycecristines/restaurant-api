...
{
    public class AuthenticationDataContext : IdentityDbContext<ApplicationUser, ApplicationRole, string>
    {
        private IConfiguration _configuration;

        public AuthenticationDataContext(IConfiguration configuration)
        {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            ConfigureKeyLength(builder);
        }

        private void ConfigureKeyLength(ModelBuilder builder)
        {
